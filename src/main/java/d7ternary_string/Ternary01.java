...
// Write the code that gives the message “I cannot multiply numbers with different signs”.
        ...
        //Object türü, Java'nın tüm sınıflarının temel sınıfı olarak önemli bir rol oynar, ancak
        // günlük programlama pratiğinde daha spesifik türlerin kullanılması genellikle daha uygun ve etkili olur.
        // Bu, tür güvenliği sağlar, kodun okunabilirliğini artırır, performansı iyileştirir ve nesneye özgü özelliklerin kullanılmasını sağlar.
