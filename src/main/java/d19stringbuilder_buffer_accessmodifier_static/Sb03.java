...
public class Sb03 {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder sb2 =new StringBuilder("Java");// Zava
        StringBuilder sb3 =new StringBuilder("Kava");// Kava
...
farklı görevleri işleyebilir ve böylece işlerin daha hızlı ve
 etkili bir şekilde tamamlanmasına olanak tanır.*/
