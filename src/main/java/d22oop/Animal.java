...
4) Class'lari kuculturuz.
    ...
    // yukarıda animal yanına mammal gelmez iki parent olmaz

    //b) Parent ve birden fazla child ile olusturulan inheritance yapilanmasin
    // Hierarchical Inheritance’ denir ve Java bunu kabul eder. ***tek parent çok chıld***

    /*c) Ama coklu parent'lardan yararlanamamak iyi olmadi. Ozelliklerini inherit etmek
    istedigimiz class'lar birden fazla ise (parent'lar) o durumda Java bize,
    Apartman tarzi yapilanma olusturmustur.( 'Multi Level Inheritance') Java bunu kabul eder.*/

    // child parenten tum şeylerini kullanamaz. kasa
